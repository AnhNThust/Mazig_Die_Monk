...
public class AudioManager : MonoBehaviour
{
    ...
    public static float VolumeSound
    {
        ...
        get => PlayerPrefs.GetFloat("VolumeSound", 1f);
    }
    ...
    public static float VolumeMusic
    {
        ...
        get => PlayerPrefs.GetFloat("VolumeMusic", .3f);
    }
    ...
    public static void PlayMusicStatic(string keyName)
    {
        if (dictionaryAudioClip.ContainsKey(keyName))
        {
    ...
    public static void Pause()
    {
        ...
        Instance?.AudioPauseHandle(Instance.musicParent, true);
    }

    public static void UnPause()
    {
        Instance?.AudioPauseHandle(Instance.soundParent, false);
        Instance?.AudioPauseHandle(Instance.musicParent, false);
    }
    ...
    public static void Clean()
    {
        ...
        Instance?.CleanAudio(Instance.musicParent);
    }
    ...
    {
        if (oldAudioSourceMusic != null)
        {
            if (audioClip == oldAudioSourceMusic.clip)
            {
                return;
            }
        }
