...
public class Spawner : MonoBehaviour
{
	...
	[SerializeField] private Button brickNoneDiamondPrefab;
	[SerializeField] private GameObject brickHaveDiamondPrefab; 
	...
	private void SpawnBrick()
	{
		...
		{
			Button brick = Instantiate(brickNoneDiamondPrefab);
			brick.name = $"Brick_{i}";
